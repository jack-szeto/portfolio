...
export const TracingBeam = ({
	...
	return (
		<motion.div
			ref={ref}
			className={cn("relative w-full mx-auto h-full", containerClassName)}
		>
			<div className="absolute -left-3.5 min-[1450px]:-left-20 top-3">
				<motion.div
					transition={{
						duration: 0.2,
						delay: 0.5,
				...
				>
					...
					<defs>
						...
						>
							<stop stopColor="#d1ff62" stopOpacity="0"></stop>
							<stop stopColor="#d1ff62"></stop>
							<stop offset="0.325" stopColor="#11ddb5"></stop>
							<stop
								offset="1"
								stopColor="#2999ff"
								stopOpacity="0"
